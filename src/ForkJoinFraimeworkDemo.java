 ...
 */
public class ForkJoinFraimeworkDemo {
    ...
    public static void main(String[] args) {
        //new ForkJoinPool().invoke(new Calc(0, TOTAL_POINTS)); //новый экземпляр форджойн пула, передаем задачу()
        Double sum = new ForkJoinPool().invoke(new CalcSum(0, TOTAL_POINTS)); // ес
    ...
    static class Calc extends RecursiveAction {
        ...
        @Override
        protected void compute() { //разбивает задачу на подзадачи
